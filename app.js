...
document.getElementById('themeSwitch').addEventListener('change', function() {
  ...
  document.querySelector('.search').classList.toggle('light-mode', this.checked);
  
  // Toggle light mode class on boxes
  document.querySelectorAll('.box').forEach(box => {
      box.classList.toggle('light-mode', this.checked);
  });

  // Toggle light mode class on specific elements
  document.querySelectorAll('#celcius, #celciusFeelLike').forEach(el => {
      el.classList.toggle('light-mode', this.checked);
  });
});
